...
return [
    ...
    "correct_php_version_is_installed" => [
        "message" => "Die benötigte PHP Version ist nicht installiert.\nBenötigt: :required\nIn Verwendung: :used",
    ...
    "directories_have_correct_permissions" => [
        "message" => "Folgende Verzeichnisse sind nicht beschreibbar:\n:directories",
    ...
    "example_environment_variables_are_set" => [
        "message" => "Folgende Umgebungsvariablen fehlen im .env Umgebungsfile, sind aber in .env.example definiert:\n:variables",
    ...
    "locales_are_installed" => [
        "message" => [
            ...
            "missing_locales" => "Folgende Sprachumgebungen (locales) fehlen:\n:locales",
    ...
    "php_extensions_are_disabled" => [
        "message" => "Die folgenden Erweiterungen sind noch immer aktiviert:\n:extensions",
        "name" => "Unerwünschte PHP Erweiterungen sind deaktiviert"
    ],
    "php_extensions_are_installed" => [
        "message" => "Die folgenden Erweiterungen fehlen:\n:extensions",
    ...
    "supervisor_programs_are_running" => [
        "message" => [
            "cannot_run_on_windows" => "Dieser Check kann unter Windows nicht ausgeführt werden..",
            "not_running_programs" => "Die folgenden Programme laufen nicht oder benötigen einen Neustart:\n:programs",
