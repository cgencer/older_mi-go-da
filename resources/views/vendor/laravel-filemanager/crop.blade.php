    ...
    <div class="text-center">
      ...
      <div class="btn-group clearfix">
        ...
        <label class="btn btn-info btn-aspectRatio" onclick="changeAspectRatio(this, null)">
          {{ trans('lfm.btn-crop-free') }}
        </label>
      </div>
      <br/>
      <br/>
      <div class="btn-group clearfix">
        <button class="btn btn-secondary" onclick="loadItems()">{{ trans('lfm.btn-cancel') }}</button>
        <button class="btn btn-warning" onclick="performCropNew()">{{ trans('lfm.btn-copy-crop') }}</button>
