    ...
    <script>
        $(document).ready(function () {
            var table = $('#dt-opt').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{route('admin.feature_groups.index.ajax')}}",
                "fixedColumns": false,
                "autoWidth": false,
                "columnDefs": [
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Feature Groups</h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <span class="breadcrumb-item active">Feature Groups</span>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
             {{--   <div class="card-header p-b-0">
                    <div class="text-right">
                        <a href="{{route('admin.feature_groups.add')}}" class="btn btn-success">Add New Group</a>
                    </div>
                </div>--}}
                <div class="card-body">
