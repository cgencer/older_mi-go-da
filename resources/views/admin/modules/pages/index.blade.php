    ...
    <script>
        $(document).ready(function () {
            var table = $('#dt-opt').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{route('admin.pages.index.ajax')}}",
                "fixedColumns": false,
                "autoWidth": false,
                "columnDefs": [
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Pages </h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        <a href="{{route('admin.dashboard')}}" class="breadcrumb-item"><i class="ti-home p-r-5"></i>Home</a>
                        <span class="breadcrumb-item">Pages</span> <span class="breadcrumb-item active">Pages </span>
                    </nav>
                </div>
                <div class="header-action float-right">
                    <a class="btn btn-gradient-success " href="{{route('admin.pages.add')}}"> <i
                            class="fa fa-plus"></i> Add New Pages</a>
                </div>
            </div>
