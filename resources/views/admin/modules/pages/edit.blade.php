    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Page Edit (ID: {{$data->id}})</h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <span class="breadcrumb-item active">Page Edit (ID: {{$data->id}})</span>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    {{ Form::open(array('url' => route('admin.pages.save',['id'=>$data->id]), 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                    <div class="row form-row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                {{Form::text('slug', $data->slug,array('class'=>'form-control','autocomplete'=>'off'))}}
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="form-group">
