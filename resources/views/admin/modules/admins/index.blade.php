    ...
    <script>
        $(document).ready(function () {
            var table = $('#dt-opt').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{route('admin.admin_users.index.ajax')}}",
                "fixedColumns": false,
                "autoWidth": false,
                "columnDefs": [
            ...
            <div class="page-header">
                ...
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <span class="breadcrumb-item">System</span> <span class="breadcrumb-item active">Admins</span>
                    </nav>
                </div>
                <div class="header-action float-right">
                    <a class="btn btn-gradient-success " href="{{route('admin.admin_users.add')}}"> <i
