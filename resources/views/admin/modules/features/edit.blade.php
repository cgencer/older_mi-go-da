...
@section('title')
    Feature Edit (ID: {{$data->id}}) | @parent
@endsection
@section('page_styles')
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Feature Edit (ID: {{$data->id}})</h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <a class="breadcrumb-item" href="{{route('admin.features.index')}}">Features</a>
                        <span class="breadcrumb-item active">Feature Edit (ID: {{$data->id}})</span>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    {{ Form::open(array('url' => route('admin.features.save',['id'=>$data->id]), 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                    <div class="row form-row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                @php
                                    $groups = \App\Models\FeatureGroups::all()->pluck('name','id')->toArray();
                                @endphp
                                {{Form::label('group_id', 'Group', array('class' => 'control-label'))}}
                                {!! Form::select('group_id', $groups, $data->group_id , ['class' => 'form-control']) !!}
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
