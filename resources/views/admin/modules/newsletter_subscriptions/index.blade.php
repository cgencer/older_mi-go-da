...
@section('title')
    Newsletter Subscriptions | @parent
@endsection
@section('page_styles')
    ...
    <script>
        $(document).ready(function () {
            var table = $('#dt-opt').DataTable({
                "processing": true,
                "serverSide": true,
                "ajax": "{{route('admin.newsletter_subscriptions.index.ajax')}}",
                "fixedColumns": false,
                "autoWidth": false,
                "columnDefs": [
                    {"orderable": false, "targets": 1},
                    {"orderable": false, "width": 120, "targets": 3},
                ],
                "order": [[3, 'desc']],
                "displayLength": 10,
                "dom": 'Blfrtip',
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Newsletter Subscriptions</h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        <a href="{{route('admin.dashboard')}}" class="breadcrumb-item"><i class="ti-home p-r-5"></i>Home</a>
                        <span class="breadcrumb-item">Other</span>
                        <span class="breadcrumb-item active">Newsletter Subscriptions</span>
                    </nav>
                </div>
            </div>
