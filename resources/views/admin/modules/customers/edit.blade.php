...
@section('title')
    Edit Customer (ID: {{$data->id}}) | @parent
@endsection
@section('page_styles')
    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Edit Customer (ID: {{$data->id}})</h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <a class="breadcrumb-item" href="{{route('admin.customers.index')}}">Customers</a>
                        <span class="breadcrumb-item active">Edit Customer (ID: {{$data->id}})</span>
                    </nav>
                </div>
            </div>
            ...
            <div class="card">
                <div class="tab-info">
                    <ul class="nav nav-tabs" role="tablist">
                        ...
                        <li class="nav-item">
                            <a href="#tab-Socials" class="nav-link" role="tab" data-toggle="tab">Socials</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="tab-Profile">
                            {{ Form::open(array('url' => route('admin.customers.save',['id'=>$data->id]), 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                            <div class="form-row">
                                <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                <div class="switch d-inline m-r-10">
                                                    {!! Form::checkbox('enabled', 1, $data->enabled,  ['id' => 'enabled']) !!}
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab-Socials">
                            <div class="p-h-15 p-v-20">
                                <p>Socials Connects</p>
                            </div>
                        </div>
                        <div role="tabpanel" class="tab-pane fade" id="tab-Security">
                            {{ Form::open(array('url' => route('admin.customers.security.save',['id'=>$data->id]), 'id'=>'security-form', 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                            <div class="p-h-15 p-v-20">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                ...
                                <div class="form-row">
                                    <div class="col-sm-12">
                                        <div class="p-h-15">
                                            <div class="form-group">
                                                <div class="text-sm-right">
                                                    <button type="submit" class="btn btn-gradient-success">Submit
                                                    </button>
                                                </div>
                                            </div>
                                        </div>
