    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">Edit User (ID: {{$data->id}})</h2>
                <div class="header-sub-title">
                    <nav class="breadcrumb breadcrumb-dash">
                        ...
                        <a class="breadcrumb-item" href="{{route('admin.users.index')}}">Hotel Users</a>
                        <span class="breadcrumb-item active">Edit User (ID: {{$data->id}})</span>
                    </nav>
                </div>
            </div>
                ...
                <div class="tab-info">
                    ...
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="tab-Profile">
                            {{ Form::open(array('url' => route('admin.users.save',['id'=>$data->id]), 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                            <div class="form-row">
                                <div class="col-sm-6">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab-Security">
                            {{ Form::open(array('url' => route('admin.users.security.save',['id'=>$data->id]), 'id'=>'security-form', 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                            <div class="p-h-15 p-v-20">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
