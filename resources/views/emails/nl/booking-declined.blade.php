...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">SLECHT NIEUWS</h1>
            <h2 class="booking-subtitle" style="font-size: 30px; font-weight: 600;line-height: 32px;">UW BOEKİNGSAANVRAAG <br> IS AFGEWEZEN</h2>
            <p class="strong">Beste {{ $name }},</p>
<br>
            <p style="">Het hotel had enkele last-minute wijzigingen in de bezetting en kan hierdoor geen kamer voor u beschikbaar stellen voor de door u gekozen data.</p>
            <p style="">U kunt de data voor dit hotel wijzigen en het opnieuw proberen of andere bestemmingen ontdekken.</p>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Wijzig Data</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Ontdek Meer</a></td>
                                    </tr>
                                    <tr>
