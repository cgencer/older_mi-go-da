...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">YOUR PAYMENT IS ON THE WAY!</h1>
            <p class="strong">Dear Migoda Hotel Partner!</p>
            <p>Good news!..</p>
            <p>We have issued your payout and it’s now on the way to you. The
                payout of €/TL xxxxxx is due to arrive to your account on xx,
                xx 2019.</p>
    ...
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            ...
            <p>If you have any questions regarding your payouts and fees,
                please contact <a class="mail_link" href="mailto:accounting@migodahotels.com">accounting@migodahotels.com</a></p>
        </div>
    </td>
</tr>
    @endsection
