...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">SCHLECHTE NACHRICHT</h1>
            <h2 class="booking-subtitle" style="font-size: 30px; font-weight: 600;line-height: 32px;">IHRE BUCHUNGSANFRAGE <br>WURDE ABGELEHNT</h2>
            <p class="strong">Liebe(r)  {{ $name }},</p>
<br>
            <p style="">Das Hotel hatte einige Last-Minute-Änderungen in Bezug auf die Belegung und kann Ihnen kein Zimmer für den von Ihnen ausgewählten Zeitraum zur Verfügung stellen.</p>
            <p style="">Sie können die Daten für dieses Hotel ändern und es erneut versuchen oder andere Ziele entdecken.</p>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Termine ändern</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Entdecke mehr</a></td>
                                    </tr>
                                    <tr>
