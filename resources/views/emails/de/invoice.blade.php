...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">IHRE BUCHUNGSÜBERSICHT</h1>
            <p class="strong">Liebe(r) {{ $name }},</p>
            <p>Wir von Migoda freuen uns, dass Sie nach {{ $hotel }} reisen.</p>
            <p>Wir wünschen Ihnen einen wundervollen Aufenthalt mit unvergesslichen Erinnerungen und Erlebnissen, die Ihr Herz erwärmen, Ihre Seele nähren und Sie wieder mit sich selbst in Verbindung bringen.</p>
            <p>Haben Sie eine wunderbare Zeit!</p>
        </div>
    </td>
</tr>
<tr>
...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h2 class="header-subtitle" style="font-weight: 600">Rechnungsübersicht</h2>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            ...
                                            "
                                            >Gezahlt mit  {{ $cardType }} ---- {{ $cardLastFour }}</p>
                                            <p style="
                                            color: #aaaaaa;
                                            font-size: 16px;
                                            font-weight: 400;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        style="font-size:0px;padding: 2px 8px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p style="line-height: normal!important;">  <span class="total-title strong">Gesamtbetrag</span> <span style="margin-top:unset!important"  class="total-subtitle">MwSt inkl.</span></p>
                                    ...
                                    <tr>
                                        ...
                                        class="main-button-holder"
                                            valign="middle"><a href=" {{ $receiptUrl }}"
                                                               class="main-button"
                                                               target="_blank">Rechnung Herunterladen</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p>&nbsp;</p>
                                    <h1 class="strong">Hotel Adresse</h1>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td class="view-map-button" align="center" bgcolor="gray" role="presentation"
                                                ...
                                                valign="middle">
                                                <br>
                                                <a href="{{ $mapUrl }}" style="background:gray;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">Auf Karte anzeigen</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
