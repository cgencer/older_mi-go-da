...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">REZERVASYONUNUZ ONAYLANDI</h1>
            <p class="strong">Sevgili {{ $name }},</p>
            <p style="">İyi haberlerimiz var!</p>
            <p style="">Otel, konaklamanızı onayladı.</p>
            <p style="">Şimdi konaklamanızı güvence altına almak için sadece aşağıdaki 'Buradan Ödeyin' düğmesine önümüzdeki 48 saat içinde tıklamanız yeterli! Aksi halde, bu teklif geçersiz hale gelecektir ve rezerve oda sistemden silinecektir. </p>
        </div>
    </td>
</tr>
<tr>
            ...
            <tr>
                <td class="booking-information-text" align="left"
                    ...
                    <div style="font-family:Arial, sans-serif;font-size:12px;line-height:1;text-align:left;color:#aba6a6;">
                        <p class="invoice-exam-title">{{ $name }} <strong  style="color: #6d6e94">tarafından Rezervasyon!</strong><br>{{ $dayNamedDate }}</p>
                    </div>
                </td>
            </tr>
        </table>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Buradan Ödeyin</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p class="note-text-red">* Bu teklifi ve bu otelde kalışınızı garantilemek için 48 saat içinde ödeme yapmanız gerekecektir.</p>
                                </div>
                            </td>
                        </tr>
    @endsection
