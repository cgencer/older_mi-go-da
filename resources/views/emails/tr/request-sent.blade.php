...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            ...
            <p class="strong" style="font-weight: bold">İstek gönderildi ...</p>
            <p style="">Rezervasyon isteğiniz seçtiğiniz otele başarıyla gönderildi.
                <br>
                <br>
                Otel müsaitlik durumunu kontrol edip, onay veya reddetme cevabı ile 48 saat içinde size geri dönecektir.
                <br>
                <br>

                Rezervasyon talebiniz kabul edildikten sonra e-postanıza, 48 saat içinde odeme yapmak ve rezervasyonunuzu tamamlamak için bir bildirim alacaksınız.
            </p>
            ...
            <tr>
                <td class="booking-information-text" align="left"
                    ...
                    <div style="font-family:Arial, sans-serif;font-size:12px;line-height:1;text-align:left;color:#aba6a6;">
                        <p class="invoice-exam-title">{{ $dayNamedDate }} tarafından rezervasyon <strong  style="color: #6d6e94">{{ $name }}!</strong><br></p>
                    </div>
                </td>
            </tr>
        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p><span class="checkin-checkout">Kişi</span> {{ $checkinCustomer }}</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p class="date-right"><span class="checkin-checkout">Çoçuk</span>  {{ $checkoutCustomer }}</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p class="date-right"> {{ $children == null ? "No " : $children}} Children</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Rezervasyon Durumunu Görüntüle</a> <br><br> </td>
                                    </tr>
                                    <tr>
