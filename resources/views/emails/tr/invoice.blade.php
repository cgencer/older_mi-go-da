...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">REZERVASYONUNUZA GENEL BAKIŞ</h1>
            <p class="strong">Sevgili {{ $name }},</p>
            <p>Migoda olarak {{ $hotel }}'e gittiğinizi görmekten çok mutluyuz</p>
            <p>Kalbinizi ısıtan, ruhunuzu besleyen ve sizi kendinize geri bağlayan unutulmaz anılar ve deneyimlerle harika bir konaklama geçirmenizi diliyoruz.</p>
            <p>Harika bir zaman geçirin!</p>
        </div>
    </td>
</tr>
<tr>
...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h2 class="header-subtitle" style="font-weight: 600">Fatura Detayları</h2>
            ...
            <tr>
                <td class="booking-information-text" align="left"
                    ...
                    <div style="font-family:Arial, sans-serif;font-size:12px;line-height:1;text-align:left;color:#aba6a6;">
                        <p class="invoice-exam-title"> <strong style="color: #6d6e94"> {{ $name }} </strong> tarafından Rezervasyon<br> {{ $dayNamedDate }}</p>
                    </div>
                </td>
            </tr>
        </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p class="date-right"> {{ $children == 0 ? "No ": $children }} Çocuk</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            ...
                                            "
                                            >  {{ $cardType }} ---- {{ $cardLastFour }} İle Ödendi</p>
                                            <p style="
                                            color: #aaaaaa;
                                            font-size: 16px;
                                            font-weight: 400;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        style="font-size:0px;padding: 2px 8px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p style="line-height: normal!important;">  <span class="total-title strong">Toplam Ödenen</span> <span style="margin-top:unset!important"  class="total-subtitle">KDV dahil</span></p>
                                    ...
                                    <tr>
                                        ...
                                        class="main-button-holder"
                                            valign="middle"><a href=" {{ $receiptUrl }}"
                                                               class="main-button"
                                                               target="_blank">PDF'i İndir</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p>&nbsp;</p>
                                    <h1 class="strong">Otel Adresi</h1>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td class="view-map-button" align="center" bgcolor="gray" role="presentation"
                                                ...
                                                valign="middle">
                                                <br>
                                                <a href="{{ $mapUrl }}" style="background:gray;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">Haritada Göster</a>
