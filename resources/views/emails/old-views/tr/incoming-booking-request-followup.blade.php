...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">GELEN REZERVASYON TALEBİ</h1>
            <p class="strong">Değerli Migoda Otel Ortağı!</p>
            <p class="strong">Size 24 saat önce bir e-posta gönderdik - henüz yanıtlamadınız.</p>
...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <p class="note-text-red">* Yanıt vermek için 24 saatiniz var!</p>
            <p class="note-text">Hızlı yanıt, misafirlerin seyahatlerini netleştirmelerine yardımcı olur ve otelinize gelmeyi dört gözle beklerler. Rezervasyon isteğine 24 saat içinde cevap vermezseniz, bu misafir / iş fırsatını kaybedersiniz.</p>
        </div>
    </td>
</tr>
    @endsection
