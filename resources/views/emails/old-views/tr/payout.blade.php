...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">ÖDEMENİZ YOLDA!</h1>
            <p class="strong">Değerli Migoda Otel Ortağı!</p>
            <p>İyi haber! ...</p>
            <p>Ödemeniz gerçekleştirilmiştir ve gönderim aşamasındadır. xxxxxx TL ödemeniz  xx,xx 2019 itibariyle hesabınıza geçmiş olucaktır. </p>
            <p>Hafta sonları ve tatil günleri göz önüne alındığında ki banka saatleri nedeniyle ödemeniz geç gelebilir.</p>
        </div>
    </td>
</tr>
<tr>
            ...
            <tr>
                <td align="center" bgcolor="#ffffff" role="presentation" style="border:1px solid #6d6f7e;border-radius:10px;cursor:auto;height:25px;padding:10px 25px;background:#ffffff;"
                    valign="middle"><a href="#" style="background:#ffffff;color:#6d6f7e;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;"
                                       target="_blank">Kazançlara Genel Bakış</a></td>
            </tr>
        </table>
    </td>
</tr>
