...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">IHRE ZAHLUNG IST AUF DEM WEG!</h1>
            <p class="strong">Lieber Migoda Hotel Partner!</p>
            <p>Gute Neuigkeiten! ...</p>
            <p>Wir haben Ihre Auszahlung vorgenommen und sie ist jetzt auf dem Weg zu Ihnen. Die Auszahlung von € / TL xxxxxx wird voraussichtlich am xx, xx 2019 erfolgen.</p>
            <p>Unter Berücksichtigung von Wochenenden und Feiertagen kann die Auszahlung aufgrund von Banköffnungszeiten etwas verzögert sein.</p>
        </div>
    </td>
</tr>
<tr>
