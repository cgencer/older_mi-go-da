...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">BONNES NOUVELLES</h1>
            <h2 class="header-subtitle">VOUS AVEZ DES CLIENTS EN ROUTE!</h2>
            <p class="strong">Cher/Chère Partenaire de Migoda Hotel!</p>
            <p>Nous sommes heureux de vous informer que le client a bien payé la partie repas du [[ date_checkin ]] - [[ date_checkout ]] afin de séjourner dans votre établissement.</p>
            <p>À moins d'une annulation imprévue de la part du client 48 heures avant son arrivée à votre établissement - Nous vous paierons ce qui suit: </p>
        </div>
    </td>
</tr>
<tr>
