...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            ...
            <p class="strong">YOUR BOOKING REQUEST HAS BEEN DECLINED</p>
            <p class="strong">Dear [[ guest_name ]],</p>
            <p>The hotel had some last minute changes in occupancy and can’t
                make a room available to you for your chosen dates.</p>
            <p>You can change the dates for this hotel and try again or
                discover other destinations.</p>
        </div>
    </td>
</tr>
<tr>
