...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">NOUVELLE DEMANDE DE RÉSERVATION</h1>
            <p class="strong">Cher (Chère) Partenaire de Migoda Hotel!</p>
            <p class="strong">Nous vous avons envoyé un email il y a 24 heures - auquel vous n'avez pas encore répondu.</p>
            ...
            <tr>
                <td align="center" bgcolor="#fa3440" role="presentation" style="border:none;border-radius:10px;cursor:auto;height:25px;padding:10px 25px;background:#fa3440;"
                    valign="middle"><a href="#" style="background:#fa3440;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;"
                                       target="_blank">Accepter / Décliner</a></td>
            </tr>
        </table>
    </td>
</tr>
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <p class="note-text-red">*Vous avez 24 heures pour répondre!</p>
            <p class="note-text">Une réponse rapide, aidera les clients à finaliser leur voyage et seront impatients de venir dans votre établissement. Si vous ne répondez pas à la demande de réservation dans un délai de 24 heures, vous perderez ce client/ cette opportunité professionnelle.</p>
        </div>
    </td>
</tr>
