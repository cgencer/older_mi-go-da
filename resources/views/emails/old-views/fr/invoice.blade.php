...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">YOUR RESERVATION OVERVIEW</h1>
            <p class="strong">Dear [[ guest_name ]],</p>
            <p>We at Migoda are so happy to see you go to [[ hotel_name ]]</p>
            <p>We are wishing you a wonderful stay with unforgettable memories
                and experiences that warm your heart, feed your soul and
                connect you back to yourself.</p>
...
<table align="center" border="0" cellpadding="0" cellspacing="0" class="zpadding-section-outlook"
       style="width:600px;" width="600">
    <tr>
        <td style="line-height:0px;font-size:0px;mso-line-height-rule:exactly;"><![endif]-->
<div class="zpadding-section" style="Margin:0px auto;max-width:600px;">
    <table align="center" border="0" cellpadding="0" cellspacing="0" role="presentation" style="width:100%;">
        <tbody>
        <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
        ...
        <tr>
            <td style="direction:ltr;font-size:0px;padding:20px 0;text-align:center;vertical-align:top;">
                ...
                <div class="mj-column-per-100 outlook-group-fix booking-date-detail"
                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                        <tr>
                            <td style="vertical-align:top;width:420px;"><![endif]-->
                    <div class="mj-column-per-70 outlook-group-fix zpadding-column"
                         style="font-size:13px;text-align:left;direction:ltr;display:inline-block;vertical-align:top;width:70%;">
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                               style="vertical-align:top;"
                               width="100%">
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p class="total-title strong">Payment</p>
                                        <p class="total-subtitle">Paid with MASTERCARD *** 3013</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                    ...
                    <!--[if mso | IE]></td>
                    <td style="vertical-align:top;width:180px;"><![endif]-->
                    <div class="mj-column-per-30 outlook-group-fix zpadding-column"
                    ...
                    <div class="mj-column-per-50 outlook-group-fix"
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:14px;line-height:20px;text-align:left;color:#6d6f7e;">
                                        [[ hotel_address ]]
                                    </div>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="right" vertical-align="middle"
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                           style="border-collapse:separate;width:100%;line-height:100%;">
                                        <tr>
                                            <td align="center" bgcolor="gray" role="presentation"
                                                style="border:none;border-radius:10px;cursor:auto;height:25px;padding:10px 25px;background:gray;"
                                                valign="middle">
                                                <a href="[[ hotel_url ]]" style="background:gray;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">
                                                    View
                                                    Map</a>
                                            </td>
                                        </tr>
