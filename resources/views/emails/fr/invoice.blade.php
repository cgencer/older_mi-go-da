...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">APERÇU DE VOTRE RÉSERVATION</h1>
            <p class="strong">Cher (Chère) {{ $name }},</p>
            <p>Nous, chez Migoda, sommes très heureux de vous voir partir à {{ $hotel }}.</p>
            <p>Nous vous souhaitons un merveilleux séjour avec des souvenirs inoubliables et des expériences qui vous réchaufferont le coeur, Nourrissez votre âme et reconnectez-vous à vous même. </p>
            <p>Passez d'excellents moments!</p>
        </div>
    </td>
</tr>
<tr>
...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h2 class="header-subtitle" style="font-weight: 600">Détails de la facture</h2>
            ...
            <tr>
                <td class="booking-information-text" align="left"
                    ...
                    <div style="font-family:Arial, sans-serif;font-size:12px;line-height:1;text-align:left;color:#aba6a6;">
                        <p class="invoice-exam-title">Réservé par<strong  style="color: #6d6e94"> {{ $name }}</strong><br> {{ $dayNamedDate }}</p>
                    </div>
                </td>
            </tr>
        </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p><span class="checkin-checkout">Arrivée</span>  {{ $checkin }}</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p class="date-right"><span class="checkin-checkout">Départ </span>  {{ $checkout }}</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p class="date-right"> {{ $children == 0 ? "No ": $children }} Enfant(s)</p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div class="package-total-title" style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p   style="line-height: normal!important;margin-bottom:unset!important">Petit-déjeuner Seulement
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p style="line-height: normal!important;">  <span  class="total-title strong">Total</span> <span style="margin-top:unset!important" class="total-subtitle">TVA incluse</span></p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            ...
                                            "
                                            >Payé avec {{ $cardType }} ---- {{ $cardLastFour }}</p>
                                            <p style="
                                            color: #aaaaaa;
                                            font-size: 16px;
                                            font-weight: 400;
                            ...
                            <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                ...
                                <tr>
                                    <td align="left"
                                        style="font-size:0px;padding: 2px 8px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                            <p style="line-height: normal!important;">  <span class="total-title strong">Total payé</span> <span style="margin-top:unset!important"  class="total-subtitle">TVA incluse </span></p>
                                    ...
                                    <tr>
                                        ...
                                        class="main-button-holder"
                                            valign="middle"><a href=" {{ $receiptUrl }}"
                                                               class="main-button"
                                                               target="_blank">Télécharger le Reçu</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p>&nbsp;</p>
                                    <h1 class="strong">Adresse de l'hôtel</h1>
                                </div>
                            </td>
                        </tr>
                        <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                        ...
                                        <tr>
                                            <td class="view-map-button" align="center" bgcolor="gray" role="presentation"
                                                ...
                                                valign="middle">
                                                <br>
                                                <a href="{{ $mapUrl }}" style="background:gray;color:#ffffff;font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:16px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;">Voir sur la carte</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
