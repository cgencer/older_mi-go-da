...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">VOTRE RÉSERVATION EST CONFIRMÉE</h1>
            <p class="strong">Cher (Chère) {{ $name }},</p>
            <p style="">Nous avons de bonnes nouvelles!</p>
            <p style="">L'hôtel a bien confirmé votre séjour.</p>
            <p style="">Maintenant, pour sécuriser votre séjour, il vous suffit de cliquer sur le bouton «Payer ici» ci-dessous dans les 48h! Après cela, l'offre expirera et la réservation sera supprimée de notre système.</p>
        </div>
    </td>
</tr>
<tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p><span class="checkin-checkout">Départ</span> {{ $checkoutCustomer }}</p>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                ...
                                <div class="package-total-title" style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p style="line-height: normal!important;margin-bottom:unset!important">Petit-déjeuner Seulemen
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                        ...
                        <tr>
                            <td align="left"
                                ...
                                <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p class="note-text-red">* Vous avez besoins de payer dans les 48 heures pour garantir cette offre et votre séjour dans cet hôtel.</p>
                                </div>
                            </td>
                        </tr>
    @endsection
