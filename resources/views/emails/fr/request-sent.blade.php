...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">Salut {{ $name }}</h1>
            <p class="strong" style="font-weight: bold">Demande envoyée ...</p>
            <p style="">Votre demande de réservation a été envoyée avec succèe à l'hôtel que vous avez choisi.
                <br>
                <br>
                L’hôtel va maintenant vérifier s’il a de la disponibilité et vous répondra dans les 48 heures avec une confirmation ou un refus.
                <br>
                <br>

                Une fois votre demande de réservation acceptée, vous recevrez une notification par email vous demandant de payer et de compléter votre réservation dans les 48 heures.
            </p>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p class="date-right"> {{ $children == null ? "No " : $children}} Enfant(s)</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                ...
                                <div class="package-total-title" style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                    <p   style="line-height: normal!important;margin-bottom:unset!important">Petit-déjeuner
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Afficher l'état de la réservation</a> <br><br> </td>
                                    </tr>
                                    <tr>
