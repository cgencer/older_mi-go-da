...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <h1 class="header-title">MAUVAISES NOUVELLES</h1>
            <h2 class="booking-subtitle" style="font-size: 30px; font-weight: 600;line-height: 32px;">VOTRE DEMANDE DE <br> RÉSERVATION A ÉTÉ DÉCLINÉE</h2>
            <p class="strong">Cher (Chère) {{ $name }},</p>
<br>
            <p style="">L’hôtel a eu des changements d’occupation de dernière minute et ne peut vous réserver une chambre aux dates que vous avez choisies.</p>
            <p style="">Vous avez la possibilité de changer de dates pour cet hôtel et essayez encore ou bien découvrez d'autres destinations.</p>
...
<tr>
    <td align="left" style="font-size:0px;padding:10px 25px;padding-top:0;padding-bottom:0;word-break:break-word;">
        <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
            <p >Détails de la demande de réservation</p>
            <h2 >{{ $hotelName }}</h2>
        </div>
    </td>
</tr>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    ...
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p><span class="checkin-checkout">Arrivée</span> {{ $checkinCustomer }}</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                            ...
                            <tr>
                                <td align="left"
                                    style="font-size:0px;padding-top:0;padding-bottom:0;word-break:break-word;">
                                    <div style="font-family:Arial, sans-serif;font-size:16px;line-height:1;text-align:left;color:#6d6f7e;">
                                        <p class="date-right"><span class="checkin-checkout">Départ</span> {{ $checkoutCustomer }}</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Changez les Dates</a></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation"
                                    ...
                                    <tr>
                                        <td align="center" bgcolor="#fa3440" role="presentation"
                                            ...
                                            class="main-button"
                                                               target="_blank">Découvrez Plus</a></td>
                                    </tr>
                                    <tr>
