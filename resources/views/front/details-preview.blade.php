                        ...
                        <div class="dates-wrapper-outer">
                            <div class="dates-wrapper">
                                <div class="date date-start">
                                    ...
                                    <h4><a href="#" class="checkin">{{ $now->format('M d, Y') }}</a>
                                    </h4>
                                </div>
                                <div class="date date-end">
                                    <h5>{{ trans('txt.det_checkout_title') }}</h5>
                                    <h4>
                                        <a href="#" class="checkout">{{ $tomorrow->format('M d, Y') }}</a>
                                    </h4>
                                </div>
                            </div>
                            <div class="datepicker-hider">
                                <input type="text" id="date-picker" data-language="{{$app_locale}}"/>
                            </div>
                        </div>
                        ...
                        <div class="clearfix select-style disable_text_highlighting">
                            <div class="select-replacement" data-target-field="guests_adult">
                                <div class="select-replacement__line1 clearfix">
                                    ...
                                    <div class="left"><span class="num_val">2</span> {{ trans('txt.guest') }}</div>
                                </div>
                                <div class="select-replacement__line2 clearfix">
                                    <div class="right">
                                        <a class="num_down"><i class="fa fa-caret-down"></i></a>
                                        <span class="num_val">2</span> <a class="num_up"><i class="fa fa-caret-up"></i></a>
                                    </div>
                            ...
                            <select name="guests_adult" id="guests_adult" style="display: none">
                                ...
                                <option value="2"
                                        selected="selected">{{trans('txt.number-guests', ['number' => 2])}}</option>
                        ...
                        <div class="clearfix select-style disable_text_highlighting">
                            <div class="select-replacement" data-target-field="guests_child">
                                <div class="select-replacement__line1 clearfix">
                                    <div class="right">
                                        <i class="fa fa-caret-down"></i><i class="fa fa-caret-up"></i></div>
                                    <div class="left"><span class="num_val">0</span> {{ trans('txt.children') }}
                                    </div>
                                </div>
                                <div class="select-replacement__line2 clearfix">
                                    <div class="right">
                                        <a class="num_down"><i class="fa fa-caret-down"></i></a>
                                        <span class="num_val">0</span> <a class="num_up"><i class="fa fa-caret-up"></i></a>
                                    </div>
...
<script src="https://cdn.jsdelivr.net/npm/sweetalert2@10"></script>
    ...
    <script>
        ...
        function checkUnavailableDates() {
            ...
            var check = false;
            @json($dates).forEach(unavaliableDate => {
    ...
    var dpicker = $('#date-picker').datepicker({
        ...
        onSelect: function (selectedDate, date, inst) {
            ...
            if (typeof (dates[0]) !== 'undefined') {
                //first date
                printFormattedDate(dates[0], 'checkin', this.language);
                $('#date_checkin').val(dates[0]);
            }

            if (typeof (dates[1]) !== 'undefined') {
                //second date
                printFormattedDate(dates[1], 'checkout', this.language);
                ...
                printFormattedDate(formattedDate(nextDay), 'checkout', this.language);
                $('#date_checkout').val(formattedDate(nextDay));
            }
            ...
            if (checkUnavailableDates()) {
                    ...
                    printFormattedDate(formattedDate(nextDay), 'checkout', this.language);
                    printFormattedDate(formattedDate(startDay), 'checkin', this.language);
