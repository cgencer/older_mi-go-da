    ...
    <div class="main-content">
        <div class="container-fluid">
            <div class="page-header">
                <h2 class="header-title">{{ trans('txt.my_profile')  }}</h2>
            </div>
            ...
            <div class="card">
                <div class="tab-info">
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item">
                            <a href="#tab-Profile" class="nav-link active" role="tab" data-toggle="tab">{{trans('txt.link_profile')}}</a>
                        </li>
                        <li class="nav-item">
                            <a href="#tab-Security" class="nav-link" role="tab" data-toggle="tab">{{trans('txt.link_security')}}</a>
                        </li>
                    </ul>
                    <div class="tab-content">
                        <div role="tabpanel" class="tab-pane fade in active" id="tab-Profile">
                            {{ Form::open(array('url' => route('hotel_admin.auth.profile.save'), 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                            <div class="form-row">
                                <div class="col-sm-6">
                                    <div class="p-h-15 p-v-20">
                                        ...
                                        <div class="form-row">
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    {{Form::label('username', trans('txt.field_username'), array('class' => 'control-label'))}}
                                ...
                                <div class="col-sm-6">
                                    <div class="p-h-15 p-v-20">
                                        <div class="form-row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{Form::label('phone', trans('txt.field_phone'), array('class' => 'control-label'))}}
                                                    {{Form::text('phone', str_replace(' ','',$data->phone),array('class'=>'form-control phone-mask'))}}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    {{Form::label('website', trans('txt.field_website'), array('class' => 'control-label'))}}
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                {{Form::label('date_of_birth', trans('txt.field_birthday'), array('class' => 'control-label'))}}
                                        ...
                                        <div class="form-group">
                                            <div class="form-group">
                                                {{Form::label('biography', trans('txt.field_bio'), array('class' => 'control-label'))}}
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab-Security">
                            {{ Form::open(array('url' => route('hotel_admin.auth.profile.security.save'), 'id'=>'security-form', 'method'=>'post', 'files' => true,'class'=>'m-t-15', 'autocomplete'=>'off')) }}
                            <div class="p-h-15 p-v-20">
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{Form::label('password', trans('txt.field_new_password'), array('class' => 'control-label'))}}
                                            {{Form::password('password', array('id'=>'password','class'=>'form-control'))}}
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            {{Form::label('password_confirmation', trans('txt.field_new_password_repeat'), array('class' => 'control-label'))}}
