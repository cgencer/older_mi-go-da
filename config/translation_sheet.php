...
return [
    ...
    */
    'serviceAccountEmail' => env('GOOGLE_SERVICE_ACCOUNT_MAIL', 'datasync-for-migoda-com@all-migoda-hotels-sheets-sync.iam.gserviceaccount.com'),
    ...
    |--------------------------------------------------------------------------
    */
    'serviceAccountCredentialsFile' => env('GOOGLE_SERVICE_ACCOUNT_JSON_LOCATION', base_path('storage/credentials-real.json')),
    ...
    */
    'spreadsheetId' => env('TS_SPREADSHEET_ID', '18KqFd2j07CEukB7VvMHqHELvg48bcEk3uYc_1lSqH0c'),
    ...
    */
    'locales' => env('TS_LOCALES', ['en', 'de', 'fr', 'tr', 'nl']),
